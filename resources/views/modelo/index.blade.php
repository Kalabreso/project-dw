...
@section('content')
  ...
  <a href ="{{route('modelo.create')}}"class="btn btn-primary mt-3">
    ...
    <th>ACTIONS</th>
          ...
          <tr>
            ...
            <td>
                ...
                <a href="{{route('modelo.edit', $item->id)}}" class="btn btn-success">
                ...
                <form action="{{route('modelo.destroy', $item->id)}}" method="POST" style="display: inline;"> 
                @csrf
                @method('DELETE')
